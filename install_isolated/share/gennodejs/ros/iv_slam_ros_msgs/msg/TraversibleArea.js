...
class TraversibleArea {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TraversibleArea(null);
  ...
  static datatype() {
    ...
    return 'iv_slam_ros_msgs/TraversibleArea';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'a10e22bc106e746ee0844376ab5bf394';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TraversibleArea(null);
...
module.exports = TraversibleArea;
