...
(cl:defmethod target_num-val ((m <moving_target_send>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:target_num-val is deprecated.  Use sensor_driver_msgs-msg:target_num instead.")
  (target_num m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<moving_target_send>)))
  ...
  "32d367dd29a680f56fcd69fbedcadee3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'moving_target_send)))
  "Returns md5sum for a message object of type 'moving_target_send"
  "32d367dd29a680f56fcd69fbedcadee3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<moving_target_send>)))
  ...
  (cl:format cl:nil "float64 time_stamp        ~%int32 target_num~%moving_target[] target          ~%~%================================================================================~%MSG: sensor_driver_msgs/moving_target~%    int32 line_num~%    Points[] line_point~%    Points center_point~%    float32 object_high~%    int32 object_type~%    int32 ID_number~%    bool is_updated~%    int32  tracked_times~%    int32  dangerous_level~%    int32  history_num~%    History_traj[] history_traj~%    int32  predict_num~%    Predict_traj[] predict_traj       ~%~%================================================================================~%MSG: sensor_driver_msgs/Points~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: sensor_driver_msgs/History_traj~%    float64 time_stamp~%    int32 line_num~%    Points[] line_point~%    Points center_point~%~%================================================================================~%MSG: sensor_driver_msgs/Predict_traj~%    float64 time_stamp~%    Points point~%    float32 v_x~%    float32 v_y~%    float32 acc_x~%    float32 acc_y~%    float32 pos_head~%    float32 v_w~%    int16 confidence_level~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'moving_target_send)))
  "Returns full string definition for message of type 'moving_target_send"
  (cl:format cl:nil "float64 time_stamp        ~%int32 target_num~%moving_target[] target          ~%~%================================================================================~%MSG: sensor_driver_msgs/moving_target~%    int32 line_num~%    Points[] line_point~%    Points center_point~%    float32 object_high~%    int32 object_type~%    int32 ID_number~%    bool is_updated~%    int32  tracked_times~%    int32  dangerous_level~%    int32  history_num~%    History_traj[] history_traj~%    int32  predict_num~%    Predict_traj[] predict_traj       ~%~%================================================================================~%MSG: sensor_driver_msgs/Points~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: sensor_driver_msgs/History_traj~%    float64 time_stamp~%    int32 line_num~%    Points[] line_point~%    Points center_point~%~%================================================================================~%MSG: sensor_driver_msgs/Predict_traj~%    float64 time_stamp~%    Points point~%    float32 v_x~%    float32 v_y~%    float32 acc_x~%    float32 acc_y~%    float32 pos_head~%    float32 v_w~%    int16 confidence_level~%~%~%"))
