...
(defsystem "sensor_driver_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "NegativeOGM" :depends-on ("_package_NegativeOGM"))
    (:file "_package_NegativeOGM" :depends-on ("_package"))
    ...
    (:file "SlopeOGM" :depends-on ("_package_SlopeOGM"))
    (:file "_package_SlopeOGM" :depends-on ("_package"))
