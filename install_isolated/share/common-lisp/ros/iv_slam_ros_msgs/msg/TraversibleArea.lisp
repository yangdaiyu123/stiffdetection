...
(cl:defclass <TraversibleArea> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass TraversibleArea (<TraversibleArea>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <TraversibleArea>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'TraversibleArea)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iv_slam_ros_msgs-msg:<TraversibleArea> is deprecated: use iv_slam_ros_msgs-msg:TraversibleArea instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <TraversibleArea>))
...
(cl:defmethod width-val ((m <TraversibleArea>))
...
(cl:defmethod height-val ((m <TraversibleArea>))
...
(cl:defmethod triD_submap_pose_image_index_x-val ((m <TraversibleArea>))
...
(cl:defmethod triD_submap_pose_image_index_y-val ((m <TraversibleArea>))
...
(cl:defmethod resolution-val ((m <TraversibleArea>))
...
(cl:defmethod triD_submap_pose-val ((m <TraversibleArea>))
...
(cl:defmethod cells-val ((m <TraversibleArea>))
...
(cl:defmethod submap_finished_flag-val ((m <TraversibleArea>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TraversibleArea>) ostream)
  "Serializes a message object of type '<TraversibleArea>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TraversibleArea>) istream)
  "Deserializes a message object of type '<TraversibleArea>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TraversibleArea>)))
  "Returns string type for a message object of type '<TraversibleArea>"
  "iv_slam_ros_msgs/TraversibleArea")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TraversibleArea)))
  "Returns string type for a message object of type 'TraversibleArea"
  "iv_slam_ros_msgs/TraversibleArea")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TraversibleArea>)))
  "Returns md5sum for a message object of type '<TraversibleArea>"
  "a10e22bc106e746ee0844376ab5bf394")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TraversibleArea)))
  "Returns md5sum for a message object of type 'TraversibleArea"
  "a10e22bc106e746ee0844376ab5bf394")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TraversibleArea>)))
  "Returns full string definition for message of type '<TraversibleArea>"
  (cl:format cl:nil "~%std_msgs/Header header~%int32 width~%int32 height~%int32 triD_submap_pose_image_index_x~%int32 triD_submap_pose_image_index_y~%float64 resolution~%geometry_msgs/Pose triD_submap_pose~%uint8[] cells~%bool submap_finished_flag~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TraversibleArea)))
  "Returns full string definition for message of type 'TraversibleArea"
  (cl:format cl:nil "~%std_msgs/Header header~%int32 width~%int32 height~%int32 triD_submap_pose_image_index_x~%int32 triD_submap_pose_image_index_y~%float64 resolution~%geometry_msgs/Pose triD_submap_pose~%uint8[] cells~%bool submap_finished_flag~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <TraversibleArea>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TraversibleArea>))
  "Converts a ROS message object to a list"
  (cl:list 'TraversibleArea
