...
#define UNKNOWN					0
#define PASSABLE				1
#define RIGIDNOPASSABLE			3
#define NEGATIVENOPASSABLE			4
#define UNFLATNESS				6
#define WATERNOPASS             2
#define GRASS					5
#define VACANT                  7
#define NEW_VACANT              8
...
class LidarProcess
{
	      ...
	      ,fpointcloud_cb_(fpointcloud_cb)
    {
        ...
        void negativeDetection(Cloud& pointcloud, int LASER_LAYER);
        void ogmDetection();
...
//        float getSectionOverlap(const CloudPointSection& section1 , const CloudPointSection& section2 ,float& beginangle ,float& endangle);
	...
	static void showOGM(const char* windowname , const OGMData<T>& ogmdata);
        ...
        void displayPointCloud(Cloud& pointcloud);
