...
(cl:defmethod cl:initialize-instance :after ((m <stiffwater>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'stiffwater)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_driver_msgs-msg:<stiffwater> is deprecated: use sensor_driver_msgs-msg:stiffwater instead.")))
...
(cl:defmethod resolution-val ((m <stiffwater>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:resolution-val is deprecated.  Use sensor_driver_msgs-msg:resolution instead.")
  (resolution m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<stiffwater>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%int16 ogmheight~%int16 ogmwidth~%int16 vehicle_x~%int16 vehicle_y~%float32 resolution~%int16[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'stiffwater)))
  "Returns full string definition for message of type 'stiffwater"
  (cl:format cl:nil "std_msgs/Header header~%int16 ogmheight~%int16 ogmwidth~%int16 vehicle_x~%int16 vehicle_y~%float32 resolution~%int16[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
