...
(cl:defmethod cl:initialize-instance :after ((m <Predict_traj>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Predict_traj)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_driver_msgs-msg:<Predict_traj> is deprecated: use sensor_driver_msgs-msg:Predict_traj instead.")))
...
(cl:defmethod point-val ((m <Predict_traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:point-val is deprecated.  Use sensor_driver_msgs-msg:point instead.")
  (point m))
...
(cl:defmethod acc_x-val ((m <Predict_traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:acc_x-val is deprecated.  Use sensor_driver_msgs-msg:acc_x instead.")
  (acc_x m))

(cl:ensure-generic-function 'acc_y-val :lambda-list '(m))
(cl:defmethod acc_y-val ((m <Predict_traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:acc_y-val is deprecated.  Use sensor_driver_msgs-msg:acc_y instead.")
  (acc_y m))

(cl:ensure-generic-function 'pos_head-val :lambda-list '(m))
(cl:defmethod pos_head-val ((m <Predict_traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:pos_head-val is deprecated.  Use sensor_driver_msgs-msg:pos_head instead.")
  (pos_head m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Predict_traj>)))
  ...
  "sensor_driver_msgs/Predict_traj")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Predict_traj)))
  "Returns string type for a message object of type 'Predict_traj"
  "sensor_driver_msgs/Predict_traj")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Predict_traj>)))
  ...
  (cl:format cl:nil "    float64 time_stamp~%    Points point~%    float32 v_x~%    float32 v_y~%    float32 acc_x~%    float32 acc_y~%    float32 pos_head~%    float32 v_w~%    int16 confidence_level~%~%================================================================================~%MSG: sensor_driver_msgs/Points~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Predict_traj)))
  "Returns full string definition for message of type 'Predict_traj"
  (cl:format cl:nil "    float64 time_stamp~%    Points point~%    float32 v_x~%    float32 v_y~%    float32 acc_x~%    float32 acc_y~%    float32 pos_head~%    float32 v_w~%    int16 confidence_level~%~%================================================================================~%MSG: sensor_driver_msgs/Points~%float64 x~%float64 y~%float64 z~%~%~%"))
