...
(cl:defclass <NegativeOGM> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass NegativeOGM (<NegativeOGM>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <NegativeOGM>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'NegativeOGM)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_driver_msgs-msg:<NegativeOGM> is deprecated: use sensor_driver_msgs-msg:NegativeOGM instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <NegativeOGM>))
...
(cl:defmethod ogmwidth-val ((m <NegativeOGM>))
...
(cl:defmethod ogmheight-val ((m <NegativeOGM>))
...
(cl:defmethod vehicle_x-val ((m <NegativeOGM>))
...
(cl:defmethod vehicle_y-val ((m <NegativeOGM>))
...
(cl:defmethod ogmresolution-val ((m <NegativeOGM>))
...
(cl:defmethod data-val ((m <NegativeOGM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:data-val is deprecated.  Use sensor_driver_msgs-msg:data instead.")
  (data m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <NegativeOGM>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <NegativeOGM>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<NegativeOGM>)))
  "Returns string type for a message object of type '<NegativeOGM>"
  "sensor_driver_msgs/NegativeOGM")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'NegativeOGM)))
  "Returns string type for a message object of type 'NegativeOGM"
  "sensor_driver_msgs/NegativeOGM")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<NegativeOGM>)))
  "Returns md5sum for a message object of type '<NegativeOGM>"
  "73234fdb4af307f5ed14f8625715b9c3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'NegativeOGM)))
  "Returns md5sum for a message object of type 'NegativeOGM"
  "73234fdb4af307f5ed14f8625715b9c3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<NegativeOGM>)))
  "Returns full string definition for message of type '<NegativeOGM>"
  (cl:format cl:nil "std_msgs/Header header~%int16 ogmwidth~%int16 ogmheight~%int16 vehicle_x~%int16 vehicle_y~%float32 ogmresolution~%int16[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'NegativeOGM)))
  "Returns full string definition for message of type 'NegativeOGM"
  (cl:format cl:nil "std_msgs/Header header~%int16 ogmwidth~%int16 ogmheight~%int16 vehicle_x~%int16 vehicle_y~%float32 ogmresolution~%int16[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <NegativeOGM>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <NegativeOGM>))
