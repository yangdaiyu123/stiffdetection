...
(cl:defclass <moving_target> (roslisp-msg-protocol:ros-message)
  ((line_num
   ...
   (line_point
    :reader line_point
    :initarg :line_point
    :type (cl:vector sensor_driver_msgs-msg:Points)
   :initform (cl:make-array 0 :element-type 'sensor_driver_msgs-msg:Points :initial-element (cl:make-instance 'sensor_driver_msgs-msg:Points)))
   (center_point
    :reader center_point
   ...
   (history_traj
    ...
    :type (cl:vector sensor_driver_msgs-msg:History_traj)
   :initform (cl:make-array 0 :element-type 'sensor_driver_msgs-msg:History_traj :initial-element (cl:make-instance 'sensor_driver_msgs-msg:History_traj)))
   (predict_num
    :reader predict_num
    :initarg :predict_num
    :type cl:integer
   ...
   (predict_traj
    ...
    :type (cl:vector sensor_driver_msgs-msg:Predict_traj)
   :initform (cl:make-array 0 :element-type 'sensor_driver_msgs-msg:Predict_traj :initial-element (cl:make-instance 'sensor_driver_msgs-msg:Predict_traj))))
)
...
(cl:defmethod line_num-val ((m <moving_target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:line_num-val is deprecated.  Use sensor_driver_msgs-msg:line_num instead.")
  (line_num m))

(cl:ensure-generic-function 'line_point-val :lambda-list '(m))
(cl:defmethod line_point-val ((m <moving_target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:line_point-val is deprecated.  Use sensor_driver_msgs-msg:line_point instead.")
  (line_point m))

(cl:ensure-generic-function 'center_point-val :lambda-list '(m))
(cl:defmethod center_point-val ((m <moving_target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:center_point-val is deprecated.  Use sensor_driver_msgs-msg:center_point instead.")
  (center_point m))
...
(cl:defmethod history_num-val ((m <moving_target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:history_num-val is deprecated.  Use sensor_driver_msgs-msg:history_num instead.")
  (history_num m))

(cl:ensure-generic-function 'history_traj-val :lambda-list '(m))
(cl:defmethod history_traj-val ((m <moving_target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:history_traj-val is deprecated.  Use sensor_driver_msgs-msg:history_traj instead.")
  (history_traj m))

(cl:ensure-generic-function 'predict_num-val :lambda-list '(m))
(cl:defmethod predict_num-val ((m <moving_target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:predict_num-val is deprecated.  Use sensor_driver_msgs-msg:predict_num instead.")
  (predict_num m))

(cl:ensure-generic-function 'predict_traj-val :lambda-list '(m))
(cl:defmethod predict_traj-val ((m <moving_target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_driver_msgs-msg:predict_traj-val is deprecated.  Use sensor_driver_msgs-msg:predict_traj instead.")
  (predict_traj m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <moving_target>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'line_point)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sensor_driver_msgs-msg:Points))
  ...
  (cl:let ((vals (cl:slot-value msg 'history_traj)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'sensor_driver_msgs-msg:History_traj))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
  ...
  (cl:let ((vals (cl:slot-value msg 'predict_traj)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'sensor_driver_msgs-msg:Predict_traj))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<moving_target>)))
  ...
  "bd64b47561f1a3a021fb713900f96bd2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'moving_target)))
  "Returns md5sum for a message object of type 'moving_target"
  "bd64b47561f1a3a021fb713900f96bd2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<moving_target>)))
  ...
  (cl:format cl:nil "    int32 line_num~%    Points[] line_point~%    Points center_point~%    float32 object_high~%    int32 object_type~%    int32 ID_number~%    bool is_updated~%    int32  tracked_times~%    int32  dangerous_level~%    int32  history_num~%    History_traj[] history_traj~%    int32  predict_num~%    Predict_traj[] predict_traj       ~%~%================================================================================~%MSG: sensor_driver_msgs/Points~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: sensor_driver_msgs/History_traj~%    float64 time_stamp~%    int32 line_num~%    Points[] line_point~%    Points center_point~%~%================================================================================~%MSG: sensor_driver_msgs/Predict_traj~%    float64 time_stamp~%    Points point~%    float32 v_x~%    float32 v_y~%    float32 acc_x~%    float32 acc_y~%    float32 pos_head~%    float32 v_w~%    int16 confidence_level~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'moving_target)))
  "Returns full string definition for message of type 'moving_target"
  (cl:format cl:nil "    int32 line_num~%    Points[] line_point~%    Points center_point~%    float32 object_high~%    int32 object_type~%    int32 ID_number~%    bool is_updated~%    int32  tracked_times~%    int32  dangerous_level~%    int32  history_num~%    History_traj[] history_traj~%    int32  predict_num~%    Predict_traj[] predict_traj       ~%~%================================================================================~%MSG: sensor_driver_msgs/Points~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: sensor_driver_msgs/History_traj~%    float64 time_stamp~%    int32 line_num~%    Points[] line_point~%    Points center_point~%~%================================================================================~%MSG: sensor_driver_msgs/Predict_traj~%    float64 time_stamp~%    Points point~%    float32 v_x~%    float32 v_y~%    float32 acc_x~%    float32 acc_y~%    float32 pos_head~%    float32 v_w~%    int16 confidence_level~%~%~%"))
