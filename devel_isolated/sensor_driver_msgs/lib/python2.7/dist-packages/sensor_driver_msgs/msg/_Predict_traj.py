...
"""autogenerated by genpy from sensor_driver_msgs/Predict_traj.msg. Do not edit."""
import sys
...
class Predict_traj(genpy.Message):
  ...
  _type = "sensor_driver_msgs/Predict_traj"
...
"""
  ...
  _slot_types = ['float64','sensor_driver_msgs/Points','float32','float32','float32','float32','float32','float32','int16']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.point is None:
        self.point = sensor_driver_msgs.msg.Points()
      if self.v_x is None:
        self.v_x = 0.
      if self.v_y is None:
        self.v_y = 0.
