...
if(slopeogm_CONFIG_INCLUDED)
  return()
endif()
set(slopeogm_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(slopeogm_SOURCE_PREFIX /home/zx/CODE/ws0214/src/slopeogm)
  set(slopeogm_DEVEL_PREFIX /home/zx/CODE/ws0214/devel_isolated/slopeogm)
  set(slopeogm_INSTALL_PREFIX "")
  set(slopeogm_PREFIX ${slopeogm_DEVEL_PREFIX})
else()
  set(slopeogm_SOURCE_PREFIX "")
  set(slopeogm_DEVEL_PREFIX "")
  set(slopeogm_INSTALL_PREFIX /home/zx/CODE/ws0214/install_isolated)
  set(slopeogm_PREFIX ${slopeogm_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'slopeogm' is deprecated")
...
set(slopeogm_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/zx/CODE/ws0214/src/slopeogm/src;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/jsoncpp;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl;/opt/ros/kinetic/include/opencv-3.3.1;/opt/ros/kinetic/include/opencv-3.3.1/opencv " STREQUAL " ")
  set(slopeogm_INCLUDE_DIRS "")
  set(_include_dirs "/home/zx/CODE/ws0214/src/slopeogm/src;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/jsoncpp;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl;/opt/ros/kinetic/include/opencv-3.3.1;/opt/ros/kinetic/include/opencv-3.3.1/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${slopeogm_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'slopeogm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'slopeogm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zx/CODE/ws0214/src/slopeogm/${idir}'.  ${_report}")
    endif()
    _list_append_unique(slopeogm_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND slopeogm_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zx/CODE/ws0214/devel_isolated/slopeogm/lib;/home/zx/CODE/ws0214/install_isolated/lib;/home/zx/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(slopeogm_LIBRARY_DIRS ${lib_path})
      list(APPEND slopeogm_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'slopeogm'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND slopeogm_LIBRARIES ${lib})
    endif()
  endif()
...
set(slopeogm_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${slopeogm_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 slopeogm_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${slopeogm_dep}_FOUND)
      find_package(${slopeogm_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${slopeogm_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(slopeogm_INCLUDE_DIRS ${${slopeogm_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(slopeogm_LIBRARIES ${slopeogm_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${slopeogm_dep}_LIBRARIES})
  _list_append_deduplicate(slopeogm_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(slopeogm_LIBRARIES ${slopeogm_LIBRARIES})

  _list_append_unique(slopeogm_LIBRARY_DIRS ${${slopeogm_dep}_LIBRARY_DIRS})
  list(APPEND slopeogm_EXPORTED_TARGETS ${${slopeogm_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${slopeogm_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
