...
if(negative_detection_CONFIG_INCLUDED)
  return()
endif()
set(negative_detection_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(negative_detection_SOURCE_PREFIX /home/zx/CODE/ws0214/src/negative)
  set(negative_detection_DEVEL_PREFIX /home/zx/CODE/ws0214/devel_isolated/negative_detection)
  set(negative_detection_INSTALL_PREFIX "")
  set(negative_detection_PREFIX ${negative_detection_DEVEL_PREFIX})
else()
  set(negative_detection_SOURCE_PREFIX "")
  set(negative_detection_DEVEL_PREFIX "")
  set(negative_detection_INSTALL_PREFIX /home/zx/CODE/ws0214/install_isolated)
  set(negative_detection_PREFIX ${negative_detection_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'negative_detection' is deprecated")
...
set(negative_detection_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/zx/CODE/ws0214/src/negative/src;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/jsoncpp;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl;/opt/ros/kinetic/include/opencv-3.3.1;/opt/ros/kinetic/include/opencv-3.3.1/opencv " STREQUAL " ")
  set(negative_detection_INCLUDE_DIRS "")
  set(_include_dirs "/home/zx/CODE/ws0214/src/negative/src;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/jsoncpp;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl;/opt/ros/kinetic/include/opencv-3.3.1;/opt/ros/kinetic/include/opencv-3.3.1/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${negative_detection_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'negative_detection' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'negative_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zx/CODE/ws0214/src/negative/${idir}'.  ${_report}")
    endif()
    _list_append_unique(negative_detection_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND negative_detection_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zx/CODE/ws0214/devel_isolated/negative_detection/lib;/home/zx/CODE/ws0214/install_isolated/lib;/home/zx/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(negative_detection_LIBRARY_DIRS ${lib_path})
      list(APPEND negative_detection_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'negative_detection'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND negative_detection_LIBRARIES ${lib})
    endif()
  endif()
...
set(negative_detection_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${negative_detection_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 negative_detection_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${negative_detection_dep}_FOUND)
      find_package(${negative_detection_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${negative_detection_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(negative_detection_INCLUDE_DIRS ${${negative_detection_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(negative_detection_LIBRARIES ${negative_detection_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${negative_detection_dep}_LIBRARIES})
  _list_append_deduplicate(negative_detection_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(negative_detection_LIBRARIES ${negative_detection_LIBRARIES})

  _list_append_unique(negative_detection_LIBRARY_DIRS ${${negative_detection_dep}_LIBRARY_DIRS})
  list(APPEND negative_detection_EXPORTED_TARGETS ${${negative_detection_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${negative_detection_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
