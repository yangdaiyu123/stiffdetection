...
if(stiff_CONFIG_INCLUDED)
  return()
endif()
set(stiff_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(stiff_SOURCE_PREFIX /home/zx/CODE/ws0214/src/stiff/stiff)
  set(stiff_DEVEL_PREFIX /home/zx/CODE/ws0214/devel_isolated/stiff)
  set(stiff_INSTALL_PREFIX "")
  set(stiff_PREFIX ${stiff_DEVEL_PREFIX})
else()
  set(stiff_SOURCE_PREFIX "")
  set(stiff_DEVEL_PREFIX "")
  set(stiff_INSTALL_PREFIX /home/zx/CODE/ws0214/install_isolated)
  set(stiff_PREFIX ${stiff_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'stiff' is deprecated")
...
set(stiff_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/zx/CODE/ws0214/src/stiff/stiff/src;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/jsoncpp;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl;/opt/ros/kinetic/include/opencv-3.3.1;/opt/ros/kinetic/include/opencv-3.3.1/opencv " STREQUAL " ")
  set(stiff_INCLUDE_DIRS "")
  set(_include_dirs "/home/zx/CODE/ws0214/src/stiff/stiff/src;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/jsoncpp;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl;/opt/ros/kinetic/include/opencv-3.3.1;/opt/ros/kinetic/include/opencv-3.3.1/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${stiff_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'stiff' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'stiff' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zx/CODE/ws0214/src/stiff/stiff/${idir}'.  ${_report}")
    endif()
    _list_append_unique(stiff_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND stiff_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zx/CODE/ws0214/devel_isolated/stiff/lib;/home/zx/CODE/ws0214/install_isolated/lib;/home/zx/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(stiff_LIBRARY_DIRS ${lib_path})
      list(APPEND stiff_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'stiff'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND stiff_LIBRARIES ${lib})
    endif()
  endif()
...
set(stiff_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${stiff_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 stiff_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${stiff_dep}_FOUND)
      find_package(${stiff_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${stiff_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(stiff_INCLUDE_DIRS ${${stiff_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(stiff_LIBRARIES ${stiff_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${stiff_dep}_LIBRARIES})
  _list_append_deduplicate(stiff_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(stiff_LIBRARIES ${stiff_LIBRARIES})

  _list_append_unique(stiff_LIBRARY_DIRS ${${stiff_dep}_LIBRARY_DIRS})
  list(APPEND stiff_EXPORTED_TARGETS ${${stiff_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${stiff_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
